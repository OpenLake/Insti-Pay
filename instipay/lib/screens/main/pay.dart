            ...
            children: [Padding(
              ...
              child: FutureBuilder(
                  ...
                  builder:
                     ...
                     bal=snapshot.data;
                    return Text("Balance    : ₹ $bal",style: TextStyle(color: Color(0xff2C0354),fontWeight: FontWeight.w700,fontSize: 16),textAlign: TextAlign.right,);
                  }
              ),
            ),Card(
              ...
              TextButton(onPressed: (){setState(() {
                checkID(ID, amount);
              });}, child: Text('Pay',style: TextStyle(fontSize: 24,fontFamily: "Roboto",fontWeight: FontWeight.w800,color: Colors.yellow),)),
              Padding(
                padding: const EdgeInsets.all(8.0),
